						...
						<div class="col-lg-9 col-md-9">
							<div class="ed_detail_wrap light">
								<div class="ed_header_caption" style="margin-top:10%;">
									<h2 class="ed_title">MEAN STACK DEVELOPMENT TRAINING</h2>
								</div>
						...
						<div class="col-lg-12 col-md-12 pt-5">
							...
							<div class="inline_edu_wrap">
								<div class="inline_edu_first">
									<h4>MEAN STACK DEVELOPMENT TRAINING</h4>
								</div>	
							</div>
								...
								<div class="tab-content" id="pills-tabContent">
									...
									<div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
										...
										<div class="edu_wraper">
											...
											<p class="text-justify">MEAN Stack development refers to the development process that falls within these particular set of technologies MongoDB, Expressjs, AngularJs, NodeJS. In simple words, MEAN Stack Developers are like JS- based application developers.</p>
                                            ...
                                            <ul style="list-style-type:disc;">
                                                ...
                                                <li>Angular(.js) -  JavaScript framework for building user interfaces</li>
